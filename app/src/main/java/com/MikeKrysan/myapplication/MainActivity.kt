 ...
 *
 *      Урок58. Вышло новое обновление для библиотеки Pix, по этой причине мы переделываем код под новую версию данной библиотеки которая теперь поддерживает версию андроид 11  а также можем уже удалить jcenter из проекта так как библиотеку уже перенесли на mavenCentral
