...
class DialogSpinnerHelper {
    ...
    fun showSpinnerDialog(context: Context, list:ArrayList<String>) {
        ...
        val adapter = RcViewDialogSpinner()     //13.8
        ...
        builder.setView(rootView)   //Чтобы builder мог отрисоватся, необходим view
    ...
    private fun setSearchView(adapter: RcViewDialogSpinner, list: ArrayList<String>, sv: SearchView?) {
        sv?.setOnQueryTextListener(object :SearchView.OnQueryTextListener{  //13.10.2 Для SearchView добавляем слушателя изменений текста
